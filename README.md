...
4. Przekazano hasła do kontenerów mysql oraz phpmyadmin przy użyciu zmiennych z przyrostkiem _FILE, które automatycznie odczytują zawartość bezpiecznie montowaną w katalogu /run/secrets/.
